    ...
    <section className="mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
      ...
      <div className="mt-8 space-y-6">
        ...
        <Card title="Quali dati raccogliamo">
          Raccogliamo i dati inseriti nel modulo di prenotazione, come nome, numero di telefono, data della prenotazione, preferenze di servizio, eventuale nome squadra Beer Pong e informazioni relative al pagamento dei servizi online.
        </Card>
